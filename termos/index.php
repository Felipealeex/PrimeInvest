...
<body>
    <header class="header">
        <nav class="navbar">
            ...
            <a href="../registro/registro.php">Abra sua Conta</a>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <hr>
            <p><strong>DECLARAÇÃO DE ACEITE</strong></p>
            <p>Ao criar sua conta você declara que leu e aceitou os Termos de Uso e Política de Privacidade do Clube de Investimentos Prime.</p>
        </div>
    </div>
</body>
</html>
