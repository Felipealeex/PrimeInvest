...
<head>
    ...
    <title>Calculadora de Renda Passiva | PrimeInvest</title>
    ...
    <header class="main-header">
        <nav class="nav-bar">
            <div class="nav-left">
              ...
              <a href="../../inicioLogin/index.php" class="nav-link">Página Inicial</a>
            </div>
            <div class="nav-right">
                <h3 id="user-name"><?php echo $usuario_nome; ?></h3>
            </div>
        </nav>
    </header>
